...
//------------------------------------------------------------------------------//
    ...
    internet.EnablePcapIpv4(routerFileName.str(), router.Get(0)->GetDevice(0), internetIpIfaces1.Get(1).first->GetObject<Ipv4>()->GetInterfaceForAddress(Ipv4Address(internetIpIfaces1.Get(1).second)), true);
    ...
    internet.EnablePcapIpv4(apWiFiFileName.str(), apWiFiNode.Get(0)->GetDevice(0), internetIpIfaces3.Get(0).first->GetObject<Ipv4>()->GetInterfaceForAddress(Ipv4Address(internetIpIfaces3.Get(0).second)), true);
